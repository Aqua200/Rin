...
export default async function (m, conn = { user: {} }) {
  ...
  console.log(`
${(chalk.cyan('╭────═[ Anika Bot ]═─────⋆'))}
${(chalk.cyan('│╭───────────────···'))}
${(chalk.cyan('┴│˚⊹♡ '))} ${chalk.blue('%s')}
${(chalk.cyan('𐙚│˚⊹♡ '))} ${chalk.black(chalk.cyan('%s'))}ㅤ${chalk.black(chalk.cyan('%s'))} 
${(chalk.cyan('𐙚│˚⊹♡ '))} ${chalk.magenta('%s [%s %sB]')}
${(chalk.cyan('𐙚│˚⊹♡ '))} ${chalk.white('%s')}
${(chalk.cyan('𐙚│˚⊹♡ '))} ${chalk.yellow('%s%s')}
